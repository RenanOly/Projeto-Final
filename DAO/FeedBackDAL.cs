...
namespace DAL
{
    public static class FeedBackDAL
    {
        ...
        public static void DeletaFeedBack()
        {
            ...
            comando.CommandText = "delete from FeedBack;";
            try
            {
            ...
            {
                throw new Exception("Erro ao deletar FeedBacks!");
            }
            conexao.Close();
           
        }
        public static string BuscarFeedBack(string CPFAluno)
        {
            SqlConnection conexao = new SqlConnection();
            conexao.ConnectionString = Configuracao.ConnectionString;
            try
            ...
            if (reader.Read())
            {
                return reader["FeedBack"].ToString();
            }
            else
            {
                return "Não há FeedBacks deste aluno!";
            }
